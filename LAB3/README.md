...
При выполнении работы я были получены практические навыки в работе с базовыми типами данных языка R.Так же изучила функции обработки данных пакета nycflights13.
