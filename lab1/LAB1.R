...
2. Выполняем команду в консоли swirl::swirl() 
3. Проходим 4 первых урока
...
## Оценка результата
В ходе работы, было пройдено 4 урока по изуычению языка R

## Вывод
В итоге были получины базовые навыки работы в RStudio Desktop и основы язака R
